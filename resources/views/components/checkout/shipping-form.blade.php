<div>
    <div
            class="flex flex-col p-4 border divide-y rounded-md border-primary-200 divide-primary-200 divide-opacity-10"
    >

        <div class="flex flex-row items-center py-2 gap-x-4">
            <span class="text-sm text-white opacity-40 whitespace-nowrap w-[70px]">Contato</span>
            <span class="text-sm text-white">{{ $user->email }}</span>
        </div>

        <div class="flex flex-row items-center py-2 gap-x-4">
            <span class="text-sm text-white opacity-40 whitespace-nowrap w-[70px]">Enviar para</span>
